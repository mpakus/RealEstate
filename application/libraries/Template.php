 ...
 * @copyright Copyright (c) 2010-2012, AOmega, http://aomega.ru
 */
class Template{
	protected
	...
	public function __construct( $settings='' ){
		get_instance()->config->load('template');
		$this->settings = get_instance()->config->item('template');
	}
	...
	/**
	 * Render page or partia template
	 *
	 * @param string $template
	 * @param bool $comeback
	 * @return Template
